 ...
 */
export function BuchKachel({ buch }: { buch: Buch }) {
    ...
    >
      <div className="relative aspect-[2/3]">
        ...
        >
          ...
          <span className="sr-only">Gehört {buch.besitzer}</span>
        </span>
        ...
        {verliehen && (
          <span
            ...
            title={`Verliehen an ${buch.ausgeliehen_an}`}
          >
            ...
            <span className="sr-only">Verliehen an {buch.ausgeliehen_an}</span>
          </span>
        )}
      </div>
    </Link>
